...
>(({ ...props }, ref) => {
  return <View {...props} ref={ref as any} />;
});
...
>(({ ...props }, ref) => {
  return <PrimitiveIcon {...props} ref={ref as any} />;
});
...
>(({ height, width, fill, color, size, stroke, as: AsComp, ...props }, ref) => {
  ...
  if (AsComp) {
    return <AsComp ref={ref as any} {...sizeProps} {...colorProps} {...props} />;
  }
  return (
    <Svg ref={ref as any} height={height} width={width} {...colorProps} {...props} />
  );
});
